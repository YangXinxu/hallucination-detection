...
class DatasetConfig(BaseModel, extra="forbid"):
    ...
    # Default is 0.9 (90% train, 10% test)
    train_ratio: Optional[float] = 0.9
    split_seed: Optional[int] = None  # If None, uses global seed
    force_split: bool = False  # If True, re-split even if samples have splits
